...
calc_indices <- function(spp, survey, force = FALSE, do_sampling_stuff = TRUE) {
...
furrr::future_pmap(to_fit, calc_indices, force = TRUE, do_sampling_stuff = FALSE)
