...
```{r, out.width="5in", fig.cap="HBLL N indices: ratio of the restricted to the original index CV. Dots represent the mean CV ratio and line segments represent the lower and upper ratios across years."}
...
```{r, out.width="0.72\\textwidth", fig.cap="Synoptic trawl survey indices calculated from a geostatistical model."}
