...
However, this increase in precision has little 
...
```{r mare-by-cv-ratio, out.width="\\textwidth", fig.cap="..."}
...
```{r indices-qcs, out.width="\\textwidth", fig.cap="SYN QCS indices calculated from a geostatistical model."}
