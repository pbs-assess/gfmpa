...
Details of geostatistical spatiotemporal models for each survey type:

The hard bottom long-line (HBLL) survey counts the number of individual fish caught for a given number of hooks (median = 450).
<!-- This hook count can be transformed into densities using the average hook spacing (0.0024384 km) and an estimate of the catch radius (0.009144 km). -->
